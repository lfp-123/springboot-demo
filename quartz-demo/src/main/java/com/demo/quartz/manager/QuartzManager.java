package com.demo.quartz.manager;

import com.demo.quartz.entity.request.AddCronJobReq;
import com.demo.quartz.entity.request.DeleteJobReq;
import com.demo.quartz.entity.request.AddSimpleJobReq;
...
public class QuartzManager {
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void addCronJob(AddCronJobReq addCronJobReq)  {
     ...
     * @throws Exception
     */
    public void removeJob(DeleteJobReq deleteJobReq)  {
        try {
    ...
    public void parseJob(String jobName,String jobGroupName){
